...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'ORG: M̴̀̈́̆̈́̽̕a̴̡̲̤͛͂ń̶̍̄urios;\n'
            + 'TEL;type=CELL;type=VOICE;waid=6283141926935:+62 831-4192-6935\n'
            + 'END:VCARD'
...
const { addafk, cekafk, isAfk } = require('./Fxc7/afknya.js')
		...
		try {
			...
			if (anu.action == 'add') {
				...
				try {
					...
					ppimg = 'https://i.ibb.co/jvbbK1y/8905e8f708cc.jpg'
				}
				...
				teks = `Kakak @${num.split('@')[0]} Baperan\nJangan Balik lagi Miss You`
				let buff = await getBuffer(ppimg)
				frhan.sendMessage(mdata.id, buff, MessageType.image, {caption: teks, contextInfo: {"mentionedJid": [num]}})
			}
		} catch (e) {
...
console.log(e)
	...
	frhan.on('chat-update', async (mek) => {
		try {
			...
			frhan.sendMessage(mek.key.remoteJid, `Hai\nMaaf sepertinya saat ini Jenny sedang *offline*\n\n*Alasan :* ${alasanafk}\n*Sejak :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik lalu`, MessageType.text, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(mek.key.remoteJid ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "mimetype": "image/jpeg", "caption": `*M̴̀̈́̆̈́̽̕a̴̡̲̤͛͂ń̶̍̄urios*`, "jpegThumbnail": imgbase64 } } } })
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
				...
				for (let ment of mek.message.extendedTextMessage.contextInfo.mentionedJid) {
					if (ment === "6283141926935@s.whatsapp.net"){
					if (isAfk(mek.key.remoteJid)) return 
					addafk(mek.key.remoteJid)
					heheh = ms(Date.now() - waktuafk)
					frhan.sendMessage(mek.key.remoteJid, `Hai\nMaaf sepertinya saat ini Jenny sedang *offline*\n\n*Alasan :* ${alasanafk}\n*Sejak :* *${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik lalu*`, MessageType.text, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(mek.key.remoteJid ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "mimetype": "image/jpeg", "caption": `*M̴̀̈́̆̈́̽̕a̴̡̲̤͛͂ń̶̍̄urios*`, "jpegThumbnail": imgbase64 } } } })
			...
			mess = {
				...
				success: '*ꜱᴜᴋꜱᴇꜱ...*',
				error: {
				 bug: '*ᴛᴇʀᴊᴀᴅɪ ᴋᴇꜱᴀʟᴀʜᴀɴ ʜᴀʀᴀᴩ ꜱᴇɢᴇʀᴀ ʟᴀᴩᴏʀ ᴋᴇᴩᴀᴅᴀ ᴏᴡɴᴇʀ ᴜɴᴛᴜᴋ ᴍᴇᴍᴩᴇʀʙᴀɪᴋɪɴyᴀ*',
			...
			const FarhanGans2 = "M̴̀̈́̆̈́̽̕a̴̡̲̤͛͂ń̶̍̄urios\n\n\n\n\n\n"
			const isUrl = (url) => {
...
const costum = (pesan, tipe, target, target2) => {
			frhan.sendMessage(from, pesan, tipe, { contextInfo: { forwardingScore: 508, isForwarded: true }, quoted: { key: { fromMe: false, participant: `${target}`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "videoMessage": { "url": "https://mmg.whatsapp.net/d/f/AlWkboTlPr0p16IFat9VcqYqHyG1iy_YdWVi7aWsvoT7.enc","fileLength": "40742","mediaKey": "c+ygokxZop+Q126P5OtJ3LgrTqtCBwe69KPDIwQJLuc=","caption": `${target2}`,"gifPlayback": true,"height": 272,"width": 224, "jpegThumbnail": Propil } } } })
		}
const cosLocation = (pesan, tipe, target, target2) => {
			frhan.sendMessage(from, pesan, tipe, {contextInfo: { forwardingScore: 508, isForwarded: true }, quoted: { key: {fromMe: false, participant: `${target}`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "locationMessage": { "degreesLatitude": 37.77628403142958, "degreesLongitude": -122.43267059326172, "name": `${target2}`, "address": "Amerika Serikat", "url": "https://foursquare.com/v/4e846b4c5503e18a127c8f6d", "jpegThumbnail": `${locbase64}` } } } } )
		}
const cosContact = (pesan, tipe, target, target2) => {
			frhan.sendMessage(from, pesan, tipe, {contextInfo: { forwardingScore: 508, isForwarded: true }, quoted: { key: {fromMe: false, participant: `${target}`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "contactMessage": {"displayName": `${target2}` ,"vcard": "BEGIN:VCARD\nVERSION:3.0\nN:M̴̀̈́̆̈́̽̕a̴̡̲̤͛͂ń̶̍̄urios;;;\nFN:M̴̀̈́̆̈́̽̕a̴̡̲̤͛͂ń̶̍̄urios\nitem1.TEL;waid=6283141926935:+62 831-4192-6935\nitem1.X-ABLabel:Ponsel\nEND:VCARD", "jpegThumbnail": Propil } } } } )
		}
const sendFakeThumb = async function(from, url, title, desc){
			var Farhan = await frhan.generateLinkPreview(url)
			Farhan.title = title
			Farhan.description = desc
			Farhan.jpegThumbnail = fs.readFileSync(imgbase64)
...
if (isGroup) {
	...
	await costum(okee, sticker, FarhanGans, FarhanGans2)
	}
	ownerku = fs.readFileSync(`./database/sticker/owner.webp`)
	if(FXC7.includes('@6283141926935')){
	await costum(ownerku, sticker, FarhanGans, FarhanGans2)
	}
	...
	const irii = await fs.readFileSync(`./database/music/iri.opus`)
	if(FXC7.includes('irii')){
	frhan.sendMessage(from, irii, audio, {mimetype: Mimetype.mp4Audio, quoted: mek, ptt: true})
	}
	const gelayy = await fs.readFileSync(`./database/music/gelay.opus`)
	if(FXC7.includes('gelay')){
	frhan.sendMessage(from, gelayy, audio, {mimetype: Mimetype.mp4Audio, quoted: mek, ptt: true})
	}
	const desahh = await fs.readFileSync(`./database/music/desah.opus`)
	if(FXC7.includes('desah')){
	frhan.sendMessage(from, desahh, audio, { mimetype: Mimetype.mp4Audio, quoted: mek, ptt: true }) 
	}
	const bernyanyii = await fs.readFileSync(`./database/music/bernyanyi.opus`)
	if(FXC7.includes('bernyanyi')){
	await frhan.sendMessage(from, bernyanyii, audio, { mimetype: Mimetype.mp4Audio, quoted: mek, ptt: true }) 
	}
	const toxiccc = await fs.readFileSync(`./database/music/toxic.opus`)
	if(FXC7.includes('anjing')){
	await frhan.sendMessage(from, toxiccc, audio, { mimetype: Mimetype.mp4Audio, quoted: mek, ptt: true }) 
	}
	const toxicccc = await fs.readFileSync(`./database/music/toxic.opus`)
	if(FXC7.includes('anjeng')){
	await frhan.sendMessage(from, toxicccc, audio, { mimetype: Mimetype.mp4Audio, quoted: mek, ptt: true }) 
	}
	const toxiccccc = await fs.readFileSync(`./database/music/toxic.opus`)
	if(FXC7.includes('anying')){
	await frhan.sendMessage(from, toxiccccc, audio, { mimetype: Mimetype.mp4Audio, quoted: mek, ptt: true }) 
	}
	const palee = await fs.readFileSync(`./database/music/pale.opus`)
	if(FXC7.includes('pale')){
	await frhan.sendMessage(from, palee, audio, { mimetype: Mimetype.mp4Audio, quoted: mek, ptt: true }) 
	}
	const jagoo = await fs.readFileSync(`./database/music/jagoan.opus`)
	if(FXC7.includes( 'kontol')){
	await frhan.sendMessage(from, jagoo, audio, { mimetype: Mimetype.mp4Audio, quoted: mek, ptt: true }) 
	}
	const jagooo = await fs.readFileSync(`./database/music/jagoan.opus`)
	if(FXC7.includes( 'kntl')){
	await frhan.sendMessage(from, jagooo, audio, { mimetype: Mimetype.mp4Audio, quoted: mek, ptt: true }) 
	}
	const sadd = await fs.readFileSync(`./database/music/sad.opus`)
	if(FXC7.includes('sad')){
	await frhan.sendMessage(from, sadd, audio, { mimetype: Mimetype.mp4Audio, quoted: mek, ptt: true }) 
	}
	const sedih = await fs.readFileSync(`./database/music/sad.opus`)
	if(FXC7.includes('sedih')){
	await frhan.sendMessage(from, sedih, audio, { mimetype: Mimetype.mp4Audio, quoted: mek, ptt: true }) 
	}
	const ciumm = await fs.readFileSync(`./database/music/kiss.opus`)
	if(FXC7.includes('cium')){
	await frhan.sendMessage(from, ciumm, audio, { mimetype: Mimetype.mp4Audio, quoted: mek, ptt: true }) 
	}
	const ngajii = await fs.readFileSync(`./database/music/ngaji.opus`)
	if(FXC7.includes('tobat')){
	await frhan.sendMessage(from, ngajii, audio, { mimetype: Mimetype.mp4Audio, quoted: mek, ptt: true }) 
	}
	const dj1 = await fs.readFileSync(`./database/music/dj1.opus`)
	if(FXC7.includes('dj')){
	await frhan.sendMessage(from, dj1, audio, { mimetype: Mimetype.mp4Audio, quoted: mek, ptt: true }) 
	}
	const terpesona = await fs.readFileSync(`./database/music/terpesona.opus`)
	if(FXC7.includes('terpesona')){
	await frhan.sendMessage(from, terpesona, audio, { mimetype: Mimetype.mp4Audio, quoted: mek, ptt: true }) 
	}
	const salamm = await fs.readFileSync(`./database/music/asalamualaikum.opus`)
	if(FXC7.includes('assalamu')){
	await frhan.sendMessage(from, salamm, audio, { mimetype: Mimetype.mp4Audio, quoted: mek, ptt: true }) 
	}
	const tarik = await fs.readFileSync(`./database/music/tarik.opus`)
	if(FXC7.includes('semongko')){
	await frhan.sendMessage(from, tarik, audio, { mimetype: Mimetype.mp4Audio, quoted: mek, ptt: true }) 
	}
	const boong = await fs.readFileSync(`./database/music/tarik.opus`)
	if(FXC7.includes('boong')){
	await frhan.sendMessage(from, tarik, audio, { mimetype: Mimetype.mp4Audio, quoted: mek, ptt: true }) 
	}
...
fs.writeFileSync('./json/database/limit.json', JSON.stringify(_limit))
}
for (var i = 0; i < commandsDB.length ; i++) {
		...
		reply(commandsDB[i].balasan)
			...
			Ucapan += "Selamat malam Istirahat gih"
			} else if (hours >= 22 || hours <= 00){
			Ucapan += "Udah Larut Malam Bobo Gih"
			} else if (hours >= 1 && hours <= 4){
			Ucapan += "Selamat pagi Bangun Gih Sholat Subuh"
			} else if (hours >= 5 && hours <= 9){
			Ucapan += "Udah Pagi Waktunya Mandi"
		...
		case 'online':
				if(!isOwner) return reply(mess.only.owner)
				offline = false
				costum(`*Status : ONLINE*`, MessageType.text, FarhanGans, FarhanGans2)
				break
		case 'offline':
				if(!isOwner) return reply(mess.only.owner)
				offline = true
				...
				alasanafk = anuu
			costum(`FITUR OFFLINE AKTIF`, MessageType.text, FarhanGans, FarhanGans2)
				break
case 'afk':
					if (!isUser)return reply(mess.only.userB)
					if (!isGroup)return reply(mess.only.group)
					reason = body.slice(5)
					teks = `「 Kamu Berhasil Afk 」\n\n• Username : ${pushname2}\n• Alasan : ${reason ? reason : 'Tanpa Alasan'}`
		...
		case 'menu':
		 case 'help':
				...
				costum(help(prefix, instagram, yt, name, pushname2, user, limitawal, uptime, JAM, tanggal(), groupName, chats, premi, groups, Simihh, Welcomee, Nsfww, BadWordd, AntiLinkk, AntiVirtexx, frhan, process, RAM, Ramadhan, Ucapan), MessageType.text, FarhanGans, FarhanGans2)
			break  
		case 'daftar':
		case 'verify':
					frhan.updatePresence(from, Presence.composing)
					if (isUser) return reply('kamu sudah Menjadi Temen Jenny❤')
					if (isBanned) return reply(mess.only.benned)
					user.push(sender)
		...
		break
			case 'vapor':
				...
				case 'my':
					...
					pp = 'https://i.ibb.co/jvbbK1y/8905e8f708cc.jpg' 
					}
					await frhan.sendMessage(from, pp, image, {caption: str, quoted:mek, contextInfo: {"mentionedJid": [sender]}})
					await cosContact({displayname: "Wanda", vcard: profilecard}, contact, FarhanGans, `${pushname2}`)
				break
				case 'listephoto':
			...
			break 
			case 'sharelock':
			await cosLocation({degreesLatitude:37.77628403142958, degreesLongitude:-122.43267059326172}, MessageType.location, FarhanGans, `[+] ~ 𝐋𝐨𝐜𝐚𝐭𝐢𝐨𝐧: Amerika Serikat\n[+] ~ 𝐂𝐫𝐞𝐚𝐭𝐞𝐝 𝐁𝐲 M̴̀̈́̆̈́̽̕a̴̡̲̤͛͂ń̶̍̄urios`)
			break 
			case 'wame':
...
await frhan.sendMessage(from, buffer, image, { quoted: mek })
await limitAdd(sender)
break
...
// fitur simple
		case 'listsurah':
			...
			case 'menumedia':
				...
				await costum(mediaa(prefix, pushname2, groupName, user, name, chats), MessageType.text, FarhanGans, FarhanGans2)
			break 
			case 'menumaker':
				user.push(sender)
				var chats = await frhan.chats.all()
				...
				await costum(creator(prefix, pushname2, groupName, user, name, chats), MessageType.text, FarhanGans, FarhanGans2)
			break 
			case 'menufun':
				user.push(sender)
				var chats = await frhan.chats.all()
				...
				await costum(fun(prefix, pushname2, groupName, user, name, chats), MessageType.text, FarhanGans, FarhanGans2)
			break 
			case 'menuspam':
				user.push(sender)
				var chats = await frhan.chats.all()
				...
				await costum(spam(prefix, pushname2, groupName, user, name, chats), MessageType.text, FarhanGans, FarhanGans2)
			break 
			case 'menuinformasi':
				user.push(sender)
				var chats = await frhan.chats.all()
				...
				await costum(informasi(prefix, pushname2, groupName, user, name, chats), MessageType.text, FarhanGans, FarhanGans2)
			break 
			case 'menuprimbon':
				user.push(sender)
				var chats = await frhan.chats.all()
				...
				await costum(primbon(prefix, pushname2, groupName, user, name, chats), MessageType.text, FarhanGans, FarhanGans2)
			break 
			case 'menuencrypt':
				user.push(sender)
				var chats = await frhan.chats.all()
				...
				await costum(encrypt(prefix, pushname2, groupName, user, name, chats), MessageType.text, FarhanGans, FarhanGans2)
			break 
			case 'menugroup':
			case 'menugrup':
				user.push(sender)
				...
				groups = frhan.chats.array.filter(v => v.jid.endsWith('g.us') && !v.read_only && v.message).map(v => v.jid)
				await costum(groupp(prefix, pushname2, groupName, user, name, chats, uptime, jam, tanggal(), premi, groups, Simihh, Welcomee, Nsfww, BadWordd, AntiLinkk, AntiVirtexx, limitawal), MessageType.text, FarhanGans, FarhanGans2)
			break 
			case 'menupremium':
				user.push(sender)
				premium.push(sender)
				...
				await costum(menupremium(prefix, pushname2, groupName, user, name, chats, premi), MessageType.text, FarhanGans, FarhanGans2)
			break 
			case 'menuothers':
				user.push(sender)
				var chats = await frhan.chats.all()
				...
				await costum(others(prefix, pushname2, groupName, user, name, chats), MessageType.text, FarhanGans, FarhanGans2)
			break 
			case 'menuowner':
				user.push(sender)
				var chats = await frhan.chats.all()
				...
				await costum(ownerrr(prefix, pushname2, groupName, user, name, chats), MessageType.text, FarhanGans, FarhanGans2)
			break 
			case 'menuscrapper':
				user.push(sender)
				var chats = await frhan.chats.all()
				...
				await costum(scrapper(prefix, pushname2, groupName, user, name, chats), MessageType.text, FarhanGans, FarhanGans2)
			break 
// end fitur simple
			...
			case 'infobot':
				...
				case 'sticker':
						...
						await ffmpeg(`./${media}`)
							...
							.on('end', function () {
								console.log('Finish')
								exec(`webpmux -set exif ${addMetadata('Manurios', 'Punya Manu')} ${ran} -o ${ran}`, async (error) => {
						...
						await ffmpeg(`./${media}`)
							...
							.on('end', function () {
								console.log('Finish')
								exec(`webpmux -set exif ${addMetadata('Mɑnurios', 'Jangan Lupa Donasi')} ${ran} -o ${ran}`, async (error) => {
									if (error) return reply(mess.error.stick)
						...
						await removeBackgroundFromImageFile({path: media, apiKey: keyrmbg, size: 'auto', type: 'auto', ranp}).then(res => {
							...
							exec(`ffmpeg -i ${ranp} -vcodec libwebp -filter:v fps=fps=20 -lossless 1 -loop 0 -preset default -an -vsync 0 -s 512:512 ${ranw}`, (err) => {
								...
								exec(`webpmux -set exif ${addMetadata('Mɑnurios', authorname)} ${ranw} -o ${ranw}`, async (error) => {
									if (error) return reply(mess.error.stick)
           ...
           case 'faketoko':
					...
					fs.unlinkSync(ranp)
					if (err) return reply(mess.error.stick)
					exec(`webpmux -set exif ${addMetadata('Mɑnurios', 'Jangan Lupa Donasi')} ${rano} -o ${rano}`, async (error) => {
					if (error) return reply(mess.error.stick)
			...
			break 
				case 'owner':
				await cosContact({displayname: "jeff", vcard: vcard}, MessageType.contact, FarhanGans, FarhanGans2)
			...
			break 
				...
				frhan.sendMessage(from, translate, MessageType.text, {quoted: mek})
				} catch {
				reply(mess.error.bug)
				}
				await limitAdd(sender)
	...
	hasil += `• *Judul:* ${drak.title}\n• *Tayang:* ${drak.type}\n• *Penonton:* ${drak.views}\n• *Rilis:* ${drak.year}\n• *Country:* ${drak.country}\n• *Url:* ${drak.link}\n\n\n`
			...
			case 'hekerbucin':
				...
				if (isLimit(sender)) return reply(ind.limitend(pusname))
					...
					try {
					reply(mess.wait)
					anu = await fetchFxc7(`https://api.vhtear.com/tiktokdl?link=${args[0]}&apikey=${VthearApi}`, {method: 'get'})
					if (anu.error) return reply(anu.error)
...
//creator
			...
			if (args.length < 1) return reply(`Kirim perintah *${prefix}ttp* teks`)
				...
				.then(async res => {
					...
					base64Img.img(ttptxt.base64, 'sticker', 'ttp', function(err, filepath) {
						...
						exec(`webpmux -set exif ./sticker/data.exif ./sticker/ttp.webp -o ./sticker/ttp.webp`, async (error) => {
							if (error) return reply(mess.error.api)
							frhan.sendMessage(from, fs.readFileSync(`./sticker/ttp.webp`), sticker, {quoted: mek})
				...
				if (args.length < 1) return reply('emoji??')
					...
					anu = await fetchFxc7(`https://mhankbarbar.tech/api/emoji2png?emo=${teks}&apiKey=${BarBarApi}`, {method: 'get'})
  ...
  if (isBanned) return reply(mess.only.benned)    
    ...
    break
				...
				if (isLimit(sender)) return reply(ind.limitend(pusname))
					...
					reply(mess.wait)
					teks = body.slice(7)
					buff = await getBuffer(`https://api.vhtear.com/slidingtext?text=${teks}&apikey=${VthearApi}`)
...
//akhir kreator
			   ...
			   try {
                    if (isBanned) return reply(mess.only.benned)    
   					if (!isUser) return reply(mess.only.userB)
   					if (isLimit(sender)) return reply(ind.limitend(pusname))
                    anu = await fetchFxc7(`https://ferdiz-api.herokuapp.com/api/stalkig/user/name=${args[0]}`, {method: 'get'})
				...
				if (!isUser) return reply(mess.only.userB)
					...
					anu = await fetchFxc7(`https://iriene-saybilla.000webhostapp.com/fakta.php?apikey=${Fxc7Api}`, {method: 'get'})
		    ...
		    case 'darkjokes':
				...
				reply(mess.wait)
				 data = fs.readFileSync('./Fxc7/drfrhan.js');
                 jsonData = JSON.parse(data);
                 randIndex = Math.floor(Math.random() * jsonData.length);
                 randKey = jsonData[randIndex];
      ...
      case 'cowok':
       if (isLimit(sender)) return reply(`Maaf ${pushname}, Kuota Limit Kamu Sudah Habis, Ketik ${prefix}limit Untuk Mengecek Kuota Limit Kamu`)
                    ...
                    var cewe = items[Math.floor(Math.random() * items.length)];
                                        ...
                                        costum(mess.wait, text, FarhanGans, FarhanGans2)
...
break
	...
	case 'bluesky':
       		if (isBanned) return reply(mess.only.benned)    
					if (!isUser) return reply(mess.only.userB)
					frhan.updatePresence(from, Presence.composing) 
					data = await fetchFxc7(`https://api.fdci.se/rep.php?gambar=aesthetic-blue-sky`, {method: 'get'})
					reply(mess.wait)
			...
			case 'instaimg':
				...
				case 'instavid':
				ini_url = args[0]
				ini_url = await fetchFxc7(`http://api.lolhuman.xyz/api/instagram?apikey=${LolApi}&url=${ini_url}`)
				ini_url = ini_url.result
				ini_type = image
				if (ini_url.includes(".mp4")) ini_type = video
				buffer = await getBuffer(ini_url)
				frhan.sendMessage(from, buffer, ini_type, { quoted: lol })
				break
				case 'jadwalsholat':
				try {
				if (isBanned) return reply(mess.only.benned)    
...
// akhir encrypt & decrypt Fitur
	...
	// new features
		...
		case 'restart':
		if (!isOwner) return reply(mess.only.ownerB)
		await costum('Wait, Sedang Merestart Bot!', text, FarhanGans, FarhanGans2)
		...
		case 'fakedeface':
		if (!isOwner) return reply(mess.only.ownerB)
		sendFakeThumb(from, args[0], `Hacked By Fxc7`, `Bukan Elite Gan:v`)
		break
		case 'turnoff':
		if (!isOwner) return reply(mess.only.ownerB)
		reply('Mematikan Bot')
		...
		case 'testing':
			...
			reply(`Setiap pesan diterima ${diff / 21}ms sender`)
		break
		case 'addbadword':
			if (!isGroupAdmins) return reply(mess.only.admin)
			...
			costum(stdout, MessageType.text, FarhanGans, FarhanGans2)
				...
				frhan.sendMessage(from, util.format(e), MessageType.extendedText, {quoted: mek})
					...
					if (isGroup && isSimi && budy != undefined) {
						...
						console.log(color('[M̴̀̈́̆̈́̽̕a̴̡̲̤͛͂ń̶̍̄urios]','aqua'), 'Command Tidak Terdaftar', color(sender.split('@')[0]))
					}
			}
			try {
					if (isGroup) {
